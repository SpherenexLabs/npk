            ...
            <HasData data={historicalData} height={300}>
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={historicalData}>
                  ...
                  <Tooltip content={<CustomTooltip />} />
                  <Legend />
                  <Area isAnimationActive={false} type="monotone" dataKey="n" stackId="1" stroke="#38a169" fill="#38a169" fillOpacity={0.6} name="Nitrogen (N)" />
                  <Area isAnimationActive={false} type="monotone" dataKey="p" stackId="1" stroke="#d69e2e" fill="#d69e2e" fillOpacity={0.6} name="Phosphorus (P)" />
                  <Area isAnimationActive={false} type="monotone" dataKey="k" stackId="1" stroke="#e53e3e" fill="#e53e3e" fillOpacity={0.6} name="Potassium (K)" />
                </AreaChart>
              </ResponsiveContainer>
            </HasData>
          </div>
            ...
            <HasData data={historicalData} height={300}>
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={historicalData}>
                  ...
                  <Area isAnimationActive={false} type="monotone" dataKey="water_pct" stroke="#3182ce" fill="#3182ce" fillOpacity={0.6} name="Water Level (%)" />
                </AreaChart>
              </ResponsiveContainer>
            </HasData>
          </div>
